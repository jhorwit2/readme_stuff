...
At AddThis, most of our engineering teams follow a two-week sprint and release cycle, which we have found to be suboptimal on our team. Two-week releases introduce too many changes which correlates to a higher risk of something going wrong. We also noticed that the more changes you introduce typically means an increased effort to track down issues. 
